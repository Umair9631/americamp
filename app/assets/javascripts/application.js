...
function initializeDatePicker() {
  $('#meeting_end_time').bootstrapMaterialDatePicker({
    weekStart: 1,
  ...
  $('#meeting_start_time').bootstrapMaterialDatePicker({
    weekStart: 1,
    format: 'dddd DD MMMM YYYY - HH:mm',
    shortTime: true,
    nowButton: true,
    ...
    return $('#meeting_end_time').bootstrapMaterialDatePicker('setMinDate', date.add(30, 'minutes'));
  });
}
